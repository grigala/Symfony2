...
namespace George\MagazineBundle\Controller;
...
use George\MagazineBundle\Entity\Publication;
use George\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('GeorgeMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("GeorgeMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('GeorgeMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GeorgeMagazineBundle:Publication:edit.html.twig")
     */
