...
use George\MagazineBundle\Entity\Issue;
use George\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('GeorgeMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("GeorgeMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('GeorgeMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GeorgeMagazineBundle:Issue:edit.html.twig")
     */
